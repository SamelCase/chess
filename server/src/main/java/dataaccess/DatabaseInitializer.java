    ...
    private static void createTables() throws DataAccessException {
        String[] createTableStatements = {
                "CREATE TABLE IF NOT EXISTS users (user_id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(50) " +
                        "UNIQUE NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(100) UNIQUE NOT NULL)",
                "CREATE TABLE IF NOT EXISTS games (game_id INT AUTO_INCREMENT PRIMARY KEY, game_name VARCHAR(100) NOT NULL, " +
                        "white_username VARCHAR(50), black_username VARCHAR(50), game_state TEXT NOT NULL)",
